...
class Modulator:
    ...
    Attributes:
        ...
        fec_enabled(bool): Whether to enable Reed-Solomon forward error correction.
    ...
    def __init__(self, carrier_freq=8800, sample_rate=44100,
                 ...
                 m_for_mfsk=64, fec_enabled=True, fec_nsym=50,
    ...
    def generate_signal(self, text):
        ...
        stepped_chirp_end = self.generate_stepped_chirp(self.postamble_duration,
                                                        self.end_chrip_seq)
        binary_data = self.__string_to_binary(text,
    ...
    def __string_to_binary(self, text, gzip_enabled=True, fec_enabled=True):
    ...
    def modulate(self, text, mode=2, compression_enabled=True, fec_enabled=True):
